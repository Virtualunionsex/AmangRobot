...
LOGGER = logging.getLogger('[LuffyRobot]')
LOGGER.info("Luffy is starting. | An Kennedy Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/virtualunionsex (t.me/panggil_m)")
...
DEV_USERS.add(5657257558)
DEV_USERS.add(5860466871)
